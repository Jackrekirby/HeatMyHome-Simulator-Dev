...
compiler_dir = cwd + 'compiler\\'
web_dir = cwd + 'docs\\'
web_file = f'{web_dir}cpp.js'
...
js_files = [f'{compiler_dir}worker_linker.js', web_file]
just_js = False
...
f = open(f'{web_dir}{js_merge_file}', "w")
